...
const About = () => {
    return (
        <div className='mt-4'>
            <h1 className='text-center font-extrabold underline text-3xl'>About Me</h1>
            <VerticalTimeline>
                ...
                >
                    ...
                    <p>Bonus: Strong communication, collaboration, and teamwork abilities. Proficient in Microsoft Office and Photoshop.</p>
                </VerticalTimelineElement>
                ...
                >
                    <h3 className="vertical-timeline-element-title">Web Development Skills</h3>
                    <h4 className="vertical-timeline-element-subtitle">HTML, CSS, Bootstrap, Tailwind</h4>
                    <p>JavaScript, React.js, Express.js, MongoDB, Firebase, SQL, MySQL</p>
                    <p>Experience with RESTful APIs, npm, and version control with GitHub.</p>
                </VerticalTimelineElement>
